...
<div class="super_container">
	<div class="home">
		<div class="home_background" style={{backgroundImage: "url('../images/contact.jpg')"}}></div>		
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row">				
				...
				<div class="col-lg-3 contact_col">
					...
					<ul class="contact_info_list estate_contact">
						...
						<li class="contact_info_item d-flex flex-row">
							<div><div class="contact_info_icon"><img src={require("../images/message.svg")}/></div></div>
							<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">contactme@gmail.com</a></div>
						</li>
						<li class="contact_info_item d-flex flex-row">
							<div><div class="contact_info_icon"><img src={require("../images/planet-earth.svg")}/></div></div>
