            ...
            <div className={`${style.contactusform}`}>
                ...
                <div className={style.footercontactformcontainer}>
                    <form id="footercontactform" className={style.footercontactform} action="post">
                        <input className={`${style.inputfield} ${style.contactformname}`} type="text" placeholder="Name" name="name" id="name_input" ref="contactName" onChange={this.changeHandler} value={this.state.name} required/>
                        <input className={`${style.inputfield} ${style.contactformemail}`} type="email" placeholder="Email" name="email" id="email_input" ref="contactEmail" onChange={this.changeHandler} value={this.state.email} required/>
                        <textarea className={`${style.textfield} ${style.contactformmessage}`} name="message" placeholder="Message" id="message_input" cols="30" rows="5" ref="contactMessage" onChange={this.changeHandler} value={this.state.message} required></textarea>
